...
<!-- NAVBAR -->
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
      <div class="container">
        <a>
        <a><img src="html-login/images/upr.png" alt="logo" style="width:65px; margin-right: 10px;">
        </a>
		...
		<div class="container">
			<div class="row">
				...
				<div style="text-align: center" class="col-md-4">
					<img class="img-fluid d-block rounded" class="img-responsive" src="images/<?= $pecah['foto_produk']; ?>" >
				</div>

				<div class="col-md-6">
					<div class="alert alert-info">
						<h6 class="alert-heading"><?php echo $pecah['nama_produk']; ?> | <?php echo "Rp. ".$pecah['harga_produk']; ?>/pcs</h6>
						<hr>
